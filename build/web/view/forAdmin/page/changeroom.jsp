<%-- 
    Document   : changeroom
    Created on : Mar 9, 2022, 5:49:40 PM
    Author     : Vu Duc Tien
--%>
                ...
                <aside class="right-side">
                    <section class="panel">
                        ...
                        <div class="panel-body col-lg-8">
                            <form class="form-horizontal tasi-form add-form" id="changeroom" action="${pageContext.request.contextPath}/admin/changeroom" method="POST">
                                        ...
                                        <div style="display: flex;">
                                            <c:forEach items="${requestScope.rooms}" var="r">
                                                <div style="margin-right: 3%;">
                                                    <input name="roomID" 
                                                           <c:forEach items="${requestScope.order.rooms}" var="room">
                                                               ${room.id eq r.id ? "checked=\"checked\"" : ""}
                                                           </c:forEach>
                                                           type="checkbox" value="${r.id}"> ${r.name}
                                                </div>
                                            </c:forEach>
                                        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-2">
                                    <button type="button" class="btn btn-danger center-block col-sm-10"
                                            onclick="location.href = '${pageContext.request.contextPath}/admin/viewaccess'">
                                        Discard
                                    </button>
                                </div>
                                <div class="col-sm-2">
                        ...
                        <script>
                            function checkNumberOfRooms() {
                                ...
                                if (Number.parseInt(checkboxes.length) !== Number.parseInt(numberOfRooms)) {
                                    ...
                                    document.getElementById('changeroom').submit();
                                }
                            }
                            ;
                        </script>
