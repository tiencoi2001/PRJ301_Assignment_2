                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body rounded-bottom bg-primary p-5">
                                        <form action="booking" method="post">
                                            ...
                                            <div class="form-group">
                                                <input name="checkIN" type="text" class="form-control border-0 p-4" placeholder="Check In" required="required" />
                                            </div>
                                            <div class="form-group">
                                                <input name="checkOUT" type="text" class="form-control border-0 p-4" placeholder="Check Out" required="required" />
                                            </div>
                                            <div class="form-group">
                                                <input name="numberOfRoom" type="text" class="form-control border-0 p-4" placeholder="Number Of Room" required="required" />
                                            </div>
                                            <div class="form-group">
                                                <select name="type">
                                            ...
                                            <div class="form-group">
                                                <input name="name" type="text" class="form-control border-0 p-4" placeholder="Fullname" required="required" />
                                            </div>
                                            <div>
